const mockModule = require("mockjs")
...
function getTimeGroupBy(fromDate, toDate) {
...
module.exports = {
  ...
  visit: (req, res) => {
    ...
    const domesticVisitSlot = []
    const abroadVisitSlot = []
